...
echo "   - DATABASE_URL:mongodb+srv://kniteesh577:mp5WIFI7uvQ1g2Av@cluster0.8cmwqgq.mongodb.net/"
echo "   - JWT_SECRET:IicXev/yBOPxfcI6Xf80AsADFpM+fd0tRfRWklqwfMs="
echo "   - JWT_REFRESH_SECRET: 5yUTLf9t0SLGnrvZiPyq0dgiqMofEw9IDRSKvRMvl8s="
